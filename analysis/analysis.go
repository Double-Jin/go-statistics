...
func main()  {
	// 获取参数
	logFilePath := flag.String("logFilePath","E:/phpStudy/PHPTutorial/nginx/logs/dig.log","log file path")
	routineNum := flag.Int("routineNum", 5, "consumer numble by goroutine")
	l := flag.String( "l", "E:/phpStudy/PHPTutorial/nginx/logs//log", "this programe runtime log target file path" )
	flag.Parse()
